	...
	public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
		return args -> {
			...
			try {
				...
				System.out.println("** Url: http://localhost:" + env.getProperty("server.port"));
				System.out.println("** Swagger: http://localhost:" + env.getProperty("server.port") + "/webjars/swagger-ui/index.html");
